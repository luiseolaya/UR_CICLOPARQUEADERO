...
<body>
    <div class="login-container">
        <div class="login-header">
            ...
            <div class="subtitle">Antes de continuar porfavor actualiza tu numero telefonico y acepta terminos y condiciones</div>
        </div>
        <form action="/UR_CICLOPARQUEADERO/app/controllers/UsuarioController.php" method="POST">
            <div class="form-floating mb-3">
                <input type="tel" class="form-control" id="floatingInput" name="celular" placeholder="Celular" required>
